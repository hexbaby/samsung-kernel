...
ifeq ($(DMVERITY_FBASED_SWITCH),true)
LOCAL_CFLAGS += -DFBASED_SWITCH
endif
...
LOCAL_C_INCLUDES += $(TOP)/vendor/samsung/system/security/drk/include/libdevkm
...
ifeq ($(PRODUCT_TRUSTZONE_TYPE), $(filter eos2 exynos3xxx exynos4xxx exynos5xxx exynos7xxx exynos8xxx msm8952 msm8937 msm8953 msm8916 msm8974 msm8994 msm8996 msm8998 sdm660 sdm845 sdm450 msm89xx msm8x26 QC8064 QC8084,$(PRODUCT_TRUSTZONE_TYPE)))
LOCAL_STATIC_LIBRARIES := libdevkm libWbSrk
LOCAL_STATIC_LIBRARIES += libcrypto
LOCAL_CFLAGS := -DUSE_LIBDEVKM
LOCAL_CFLAGS += -DUSE_KEYSESSION_API
endif
endif
LOCAL_STATIC_LIBRARIES += libz libQSEEComAPIStatic libc liblog libext4_utils 
...
LOCAL_SRC_FILES := $(LOCAL_PATH)/arm64/libcrypto_static_dmverity.a
...
LOCAL_SRC_FILES := $(LOCAL_PATH)/libcrypto_static_dmverity.a
include $(PREBUILT_STATIC_LIBRARY)
endif
...
LOCAL_STATIC_LIBRARIES := libc libcrypto
include $(BUILD_EXECUTABLE)
...
LOCAL_C_INCLUDES += system/extras/ext4_utils/include system/vold
...
LOCAL_STATIC_LIBRARIES := libext4_utils libsparse libdmverity_hashgen libz
...
else ifneq (,$(filter heroq% hero2q%,$(TARGET_PRODUCT)))
LOCAL_SRC_FILES := dm_verity_make_ext4fs_heroq.py
else
...
ifeq ($(TARGET_SOC),exynos9810)
LOCAL_SRC_FILES := dm_verity_make_ext4fs_9810.py
endif
ifeq ($(TARGET_SOC),exynos7420)
...
LOCAL_C_INCLUDES += $(LOCAL_PATH)/..
LOCAL_C_INCLUDES += system/extras/ext4_utils/include $(TOP)/external/boringssl/include
